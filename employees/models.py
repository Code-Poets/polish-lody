...
class Employee(models.Model):
    first_name = models.CharField(max_length=250, blank=True, default=None)
    last_name = models.CharField(max_length=250, blank=True, default=None)
    email = models.EmailField(max_length=75, blank=True, unique=True, default=None)
